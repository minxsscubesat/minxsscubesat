...
*MinXSS* was developed as a student project at the University of Colorado (CU) in Boulder and the Laboratory for Atmospheric and Space Physics (LASP). The students along with a few scientists and engineers at LASP designed, built, integrated, tested, and operated the 3-Unit (3U) MinXSS CubeSat. Over 40 graduate students, 3 undergraduate students, and one high school student worked on MinXSS. It includes an Amptek X123 Silicon Drift Detector (SDD) as the main science instrument and was first to demonstrate the excellent attitude control of better than 10 arc-sec pointing with the Blue Canyon Technologies (BCT) Attitude Determination and Control System (ADCS). The UHF radio on MinXSS CubeSat is the AstroDev Li-1 radio. All other satellite subsystems were developed in-house. 

*MinXSS-1* was deployed from the International Space Station on 2016 May 16, and began normal operations on 2016 June 9. *MinXSS* re-entered (burned up) on 2017 May 6. The *MinXSS* mission was highly successful as both a technology demonstration mission for the Amptek X123 and BCT ADCS and as a science mission in obtaining thousands of high quality solar SXR spectra during the declining phase of solar cycle 23. 

The MinXSS-2 was launched on 3 December 2018 into a polar orbit. The MinXSS-2 first light was on 2018 December 7 and operated nominally until there was a communication anomaly on 2019 January 9.  While shorter mission than planned, MinXSS-2 mission did provide a month of solar SXR spectra during the quiescent period near solar cycle minimum and thus provided important data for studying solar cycle variablity.

With the MinXSS-2 communication anomaly impacting our science plans, two CU graduate students, Bennet Schwab and Robert Sewell, quickly developed the next *MinXSS* instrument with a flight of opportunity on CU's international small satellite called InspireSat-1. They developed a novel instrument with a dual-zone aperture to enhance broader energy coverage and better sensitivity, and with electronics improvements by Amptek for the X123 SDD, this *MinXSS-3* instrument provides much improved solar SXR spectra over those from MinXSS-1 and -2.  These improvements include much better energy resolution of 0.05 keV at 1 keV, larger signal, wider dynamics range, and broader energy coverage. Bennet and Robert also named this new instrument the Dual-zone Aperture X-ray Solar Spectrometer (DAXSS) to help distinguish it from the previous MinXSS instruments. InspireSat-1 was launched on 2022 February 14, and DAXSS solar observations have been routine since 2022 February 28.  Thousands of DAXSS solar SXR spectra are already in the DAXSS Level 1 product, and it is growing daily.  The spring of 2022 has had rapid increase in solar activity towards solar cycle 25 maximum.
...
In addition, there are short news articles about MinXSS-DAXSS (e.g. first-light news) posted at https://lasp.colorado.edu/home/minxss/news/
...
This *MinXSS* Data User Guide provides examples on how to use the *MinXSS* Level 1 product (its main science product) to examine solar SXR spectra and variability over time using some of the Python and IDL code provided with the MinXSS-1, MinXSS-2, and DAXSS data archive.

Make sure that you’ve already downloaded the *MinXSS* data either as an [IDL saveset (.sav) from our website](http://lasp.colorado.edu/home/minxss/data/level-1/) or as a [netCDF from the archive at NASA](https://cdaweb.gsfc.nasa.gov/index.html/). Loading and plotting for data levels other than Level 1 are archived using similar syntax to that shown below. Just inspect the variables for differences in names. The MinXSS-1 and MinXSS-2 data sets are very similar, but there are some differences for the InspireSat-1 DAXSS data set due to having different spacecraft subsystems on InspireSat-1.
