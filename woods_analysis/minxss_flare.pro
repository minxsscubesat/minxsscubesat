...
if n_params() lt 1 then begin
	print, ' '
	print, 'USAGE:  minxss_flare, date, result, selections, fm=fm, /reload, /eps, $'
...
plotdir = getenv('minxss_data')+slash+'flares'+slash
ans = ' '
...
;
  ...
  if not keyword_set(nolines) then begin
    ...
    lineY = [ 15., 15, 10, 10, 3, 3, 3, 3, 3, 0.6, 0.6, 0.25]
    yrange2 = [1E-3,1E2]
...
if keyword_set(debug) then stop, 'DEBUG at end of minxss_flare ...'
