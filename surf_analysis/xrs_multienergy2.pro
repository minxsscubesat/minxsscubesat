...
pro xrs_multienergy2, channel, itime=itime, debug=debug, data=data
;
;	1.  Check input parameters
;
data = -1L
...
henke = read_dat( fluxdir + 'RXRS_HENKE_v16.dat' )
...
case ch of
    ...
    'B1': begin
		energy = [ 285, 331, 361, 380, 408 ]
		nenergy = n_elements(energy)
		dvfiles = [ 'XRS Raw Dump_12_01_10_12-30' ]
		surffiles = [ 'surflog_12-01-10_1230' ]
		ihenke = 3
       end
    'B2': begin
		energy = [ 285, 331, 361, 380, 408 ]
		nenergy = n_elements(energy)
		dvfiles = [ 'XRS Raw Dump_12_02_10_11-09' ]
		surffiles = [ 'surflog_12-02-10_1109' ]
		ihenke = 4
      end
endcase
...
;
dfile = chdir + dvfiles
sfile = chdir + surffiles
if keyword_set(debug) then begin
    plotxrs, ch, dfile, sfile, itime=integtime, data=dall, /debug
endif else begin
    plotxrs, ch, dfile, sfile, itime=integtime, data=dall
endelse
