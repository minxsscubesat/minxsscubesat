...
;
pro dualsps_fft_diff, pd_track, pd_open, cutoff=cutoff, debug=debug

if n_params() lt 2 then begin
	print, 'USAGE: dualsps_fft_diff, pd_track, pd_open, cutoff=cutoff, /debug'
	print, '    where '
	print, '            pd_track and pd_open are "plotdata" from dualsps_track.pro '
	return
endif
...
if keyword_set(debug) then begin
	stop, 'DEBUG at end of dualsps_fft_diff ...'
endif
end
