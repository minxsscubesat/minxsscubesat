...
;
; CALLING SEQUENCE:
;	dualsps_plot, channel, [ filename, surffile, /debug, data=data, surfdata=surfdata, plotdata=plotdata]
;
; INPUTS:
...
pro dualsps_plot, channel, filename, surffile, debug=debug, $
...
if n_params() lt 1 then begin
  print, 'Usage:  dualsps_plot, channel, [ filename, surffile, /debug, data=data, surfdata=surfdata, plotdata=plotdata]'
  return
endif
...
if (doPrint ne 0) then begin
	print, ' '
	print, ch, ' Median signal ', median( plotdata.signal)
	print, '     Quad X Median ', median( plotdata.quadx)
	print, '     Quad Y Median ', median( plotdata.quady)
	print, ' '
endif
