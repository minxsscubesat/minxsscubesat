...
; 30-Jun-2017, Christopher S. More.  Added defaults for 9th parameter (Ni abundances)

;-
;------------------------------------------------------------------------------

FUNCTION F_VTH_ABUN_DEFAULTS

defaults = { $
  fit_comp_params:           [1e0,   .2,    1.,   1.,  1.,  1.,  1.,  1.,  1.], $
  fit_comp_minima:           [1e-20, 1e-1, .1, .1, .1, .1, .1, .1, .1], $
  fit_comp_maxima:           [1e20,  8.,   10.,  10., 10., 10., 10., 10., 10.], $
  fit_comp_free_mask:        [1b,    1b,   1b,   0b,  0b,  0b, 0b, 0b,  0b], $
