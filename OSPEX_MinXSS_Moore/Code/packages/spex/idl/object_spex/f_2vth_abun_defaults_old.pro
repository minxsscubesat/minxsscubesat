...
FUNCTION F_2VTH_ABUN_DEFAULTS_OLD

defaults = { $
  fit_comp_params:           [1e0,   2,    1e0,   2,     1.,  1.,  1.,  1.,  1.,  1.], $
  fit_comp_minima:           [1e-20, 5e-1, 1e-20, 5e-1, .01, .01, .01, .01, .01, .01], $
  fit_comp_maxima:           [1e20,  8.,   1e20,  8.,   10., 10., 10., 10., 10., 10.], $
  fit_comp_free_mask:        [1b,    1b,   1b,    1b,    1b,  1b,  0b,  0b,  0b,  0b], $
