...
; 20-June-2017, Christopher Samuel Moore, madified with new extended CHIANT continuum data, to fgo from 5 - 8 MK and 0.1 - 30 keV (be cautious below 1 keV, the spectral resolution and accuracy of the continuum is poor!!)


function setup_chianti_lines_test_cm, ioneq,  kmin, kmax, temp_range,$
    ntemp=ntemp, nelem=nelem, savfile=savfile, overwrite=overwrite



default, savfile, 'chianti_lines_test_cm.sav'
default, overwrite, 0
default, nelem, 15
fcount = 0
