...
;  force SCI sectors onto modulus 7 steps
offsets[1,*] = long(offsets[1,*] / 7) * 7L

if keyword_set(verbose) then begin
  print, 'HK   Write Offset = ', offsets[0,*]
  print, 'SCI  Write Offset = ', offsets[1,*]
  print, 'ADCS Write Offset = ', offsets[2,*]
  print, 'LOG  Write Offset = ', offsets[3,*]
endif
