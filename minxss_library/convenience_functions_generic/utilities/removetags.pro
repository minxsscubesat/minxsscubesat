...
;
; Use         : newStruture = RemoveTags(structure, tagNames)
;
; Inputs      :	structure = input structure (array or scalar)
;             : tagNames = array of tag names to remove
;
; Outputs     :	newStructure = new structure without the tags in tagNames
;
; Opt. Outputs:	None.
;
; Keywords    :	None
...
;                2015/11/09: James Paul Mason: Changed name and cleaned up code
;
;-

function RemoveTags,struct,tag_name, no_recurse=no_recurse,$
...
if IsA(tag_name, /STRING) then begin
