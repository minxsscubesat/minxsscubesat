...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_hk_playback_range HkStart 1 HkStop 2 HkStep 3
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_log_playback_range LogStart 4 LogStop 5 LogStep 6
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_science_playback_range SciStart 7 SciStop 8 SciStep 9
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_adcs_playback_range AdcsStart 10 AdcsStop 11 AdcsStep 12
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_diag_playback_range DiagStart 13 DiagStop 14 DiagStep 15
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
...
while MINXSSCmdAcceptCnt < $cmdCnt
	set cmdTry = cmdTry + 1
	set_ximg_playback_range XimgStart 16 XimgStop 17 XimgStep 18
	wait 3529
endwhile
set cmdSucceed = cmdSucceed + 1
wait 1000
