...
# THIS CODE WAS MODIFIED ON 12/2/2015 TO BE COMPATIBLE WITH PYTHON 3.4
...
def gpsFromUTC(year, month, day, hour, min, sec, leapSecs=14):
    ...
    return gps_secs #(gpsWeek, gpsSOW, gpsDay, gpsSOD)


def UTCFromGps(gps_seconds, leapSecs=14):
