;+
; NAME:
;   minxss_create_uniform_packet_time_mulithread_callback
;
; PURPOSE:
;   Callback procedure for the multi-threading in minxss_create_uniform_packet_times. 
...
;
; EXAMPLE:
;   None -- this code should only be called internally by minxss_create_uniform_packet_times
;
; MODIFICATION HISTORY:
;   2016/06/27: James Paul Mason: Wrote script.
;-
PRO minxss_create_uniform_packet_time_mulithread_callback, status, error, node, userdata
STOP
