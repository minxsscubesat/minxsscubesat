...
if (num_x123_el gt 1) then $
	oplot, hkdoy[wx123_el_best], hk[wx123_el_best].x123_slow_count, psym=4, color=ceclipse
if (num_x123_sun gt 1) then $
	oplot, hkdoy[wx123_sun_best], hk[wx123_sun_best].x123_slow_count, psym=4, color=csun
...
plot12 = 'minxss1_report_'+datestr+'_plot12_x123_goes.eps'
if doEPS ne 0 then begin
	print, 'Writing EPS plot to ', plot12
	eps2_p,plotdir+plot12
endif
...
plot, scidoy[wsci], fast_count[wsci], /nodata, psym=1, xr=xrange, xs=1, yr=yr, ys=1, $
	xtitle=xtitle, ytitle=ytitle, title=mtitle, /ylog

oplot, hkdoy[wx123_sun_best], hk[wx123_sun_best].x123_slow_count, psym=1, color=csun
