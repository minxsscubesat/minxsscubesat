...
;
; USAGE
;   minxss2_read_packets, input, hk=hk, sci=sci, log=log, diag=diag, xactimage=xactimage, $
...
pro minxss2_read_packets, input, hk=hk, sci=sci, log=log, diag=diag, xactimage=xactimage, $
                          ...
                          EXPORT_RAW_ADCS_TLM = EXPORT_RAW_ADCS_TLM, verbose=verbose, kiss=kiss, _extra=_extra
...
;print, "SEQ = " + string(fix(sci_struct1.seq_flag))
          if ((sci_struct1.seq_flag AND '01'X) eq 1) then begin
            ...
            ; count (0=no errors) - THESE ERRORS HAVE CHANGED FOR FM2
