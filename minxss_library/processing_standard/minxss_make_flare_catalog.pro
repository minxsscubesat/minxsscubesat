...
FOR flare_index = 0, n_elements(flare_start_jd) - 1 DO BEGIN
  ...
  time_jd_this_flare = time_jd[time_indices]
  ...
  save, minxss_flare, time_jd_this_flare, filename = saveloc + 'IDL Savesets/' + jpmjd2iso(goesEvents[flare_index].eventPeakTimeJd) + ' ' + strtrim(goesEvents[flare_index].st$class, 2) + '.sav'
