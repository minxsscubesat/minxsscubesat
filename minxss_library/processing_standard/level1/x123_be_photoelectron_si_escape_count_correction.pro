...
;+
; NAME:
;   X123_be_photoelectron_si_escape_count_correction
;
; AUTHOR:
...
;
;
; CALLING SEQUENCE: result = X123_be_photoelectron_si_escape_count_correction(x123_energy_bins_kev, converted_energy_bins_offset_bins, x123_measured_counts, counts_uncertainty=uncertainty_x123_measured_counts, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, $
...
function X123_be_photoelectron_si_escape_count_correction, x123_energy_bins_kev, converted_energy_bins_offset_bins, x123_measured_counts, counts_uncertainty=uncertainty_x123_measured_counts, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, $
  X123_count_contribution_Be_Si_photopeak_ARRAY=output_model_X123_count_contribution_Be_Si_photopeak, $
  X123_count_contribution_Be_photoelectron_ARRAY=output_model_X123_count_contribution_Be_photoelectron, $
  X123_count_contribution_Si_escape_all_ARRAY=output_model_X123_count_contribution_Si_escape_all, $
  X123_corrected_count_contribution_Si_escape_all_ARRAY=output_model_X123_corrected_count_contribution_Si_escape_all, $
