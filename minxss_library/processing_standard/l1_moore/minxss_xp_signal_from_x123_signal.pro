...
;
; PURPOSE: Calculate the detected MinXSS xp signal (DN/s) from an input photon flux in units of counts/s/keV, derived from the inverted X123 measured count spectrum in units of counts/s/keV, /use_detector_area is set (units of cm^2)
;
;
;
...
function minxss_XP_signal_from_X123_signal, x123_energy_bins_kev, converted_energy_bins_offset_bins, x123_measured_counts, counts_uncertainty=uncertainty_x123_measured_counts, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn, $
  ...
  ;Invert the X123 measured signal to estimate the input photon flux
      X123_photon_estimate_ARRAY = X123_invert_count_to_photon_estimate(x123_energy_bins_kev, converted_energy_bins_offset_bins, x123_measured_counts, counts_uncertainty=uncertainty_x123_measured_counts, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file,  use_detector_area=use_detector_area, $
  ...
  X123_photon_estimate_be_si_photopeak_only_ARRAY_positive = X123_photon_estimate_be_si_photopeak_only_ARRAY[index_positive_energies]
  X123_inverted_counts_to_photons_be_photoelectron_only_ARRAY_positive = X123_inverted_counts_to_photons_be_photoelectron_only_ARRAY[index_positive_energies]
  ...
  If KEYWORD_SET(uncertainty_x123_measured_counts) THEN BEGIN
    ...
    uncertainty_X123_inverted_counts_to_photons_be_photoelectron_only_ARRAY_positive_positive = uncertainty_X123_inverted_counts_to_photons_be_photoelectron_only_ARRAY_positive[index_positive_energies]
  Endif
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
output_model_xp_DN_signal_estimate = minxss_xp_signal_estimate(converted_energy_bins, X123_photon_estimate_ARRAY_positive, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, output_minxss_xp_signal_fC=output_model_xp_fC_signal_estimate, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn)
;be_si_photopeak_only
output_model_xp_DN_signal_estimate_be_si_photopeak_only = minxss_xp_signal_estimate(converted_energy_bins, X123_photon_estimate_be_si_photopeak_only_ARRAY_positive, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, output_minxss_xp_signal_fC=output_model_xp_fC_signal_estimate_be_si_photopeak_only, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn)
;be photoelectron_onlyoutput_model_xp_DN_signal_estimate_be_si_photopeak_only
output_model_xp_DN_signal_estimate_be_photoelectron_only = minxss_xp_signal_estimate(converted_energy_bins, X123_inverted_counts_to_photons_be_photoelectron_only_ARRAY_positive, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, output_minxss_xp_signal_fC=output_model_xp_fC_signal_estimate_be_photoelectron_only, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
If KEYWORD_SET(uncertainty_x123_measured_counts) THEN BEGIN
  ...
  ;be_photoelectron
  ;high
  output_model_xp_DN_signal_estimate_be_photoelectron_only_high = minxss_xp_signal_estimate(converted_energy_bins, X123_photon_estimate_be_photoelectron_only_ARRAY_positive+uncertainty_x123_inverted_counts_to_photons_be_photoelectron_only_positive, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, output_minxss_xp_signal_fC=output_model_xp_fC_signal_estimate_be_photoelectron_only_high, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn)
  ;low
  output_model_xp_DN_signal_estimate_be_photoelectron_only_low = minxss_xp_signal_estimate(converted_energy_bins, X123_photon_estimate_be_photoelectron_only_ARRAY_positive-uncertainty_x123_inverted_counts_to_photons_be_photoelectron_only_positive, minxss_instrument_structure_data_file=minxss_instrument_structure_data_file, use_detector_area=use_detector_area, output_minxss_xp_signal_fC=output_model_xp_fC_signal_estimate_be_photoelectron_only_low, input_minxss_xp_gain_fC_per_dn=input_minxss_xp_gain_fC_per_dn)
  ;DN
